...
import {
  ...
  ChevronLeft, ChevronRight, Users, Eye, Pencil, Trash2, Sparkles,
} from "lucide-react";
...
import { ClientAgentPanel } from "@/components/client-agent-panel";
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={agentOpen ? "" : "border-primary/30 text-primary hover:bg-primary/5"}
              >
