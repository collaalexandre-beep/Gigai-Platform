...
export const purchaseRequests = pgTable(
  "purchase_requests",
  {
    ...
    ordemCompraNumero: text("ordem_compra_numero"),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().notNull(),
  },
  (t) => [
...
export const suppliers = pgTable(
  "suppliers",
  {
    ...
    observacao: text("observacao"),
    ativo: boolean("ativo").notNull().default(true),
    aceitaCotacaoWhatsapp: boolean("aceita_cotacao_whatsapp").notNull().default(false),
    whatsappAutorizado: boolean("whatsapp_autorizado").notNull().default(false),
    templateCotacaoNome: text("template_cotacao_nome"),
    idiomaTemplateCotacao: text("idioma_template_cotacao").notNull().default("pt_BR"),
    ultimoContatoWhatsapp: timestamp("ultimo_contato_whatsapp"),
    observacaoWhatsapp: text("observacao_whatsapp"),
